...
The binary in this repository is build `05a5da0a4c87`.

## Quick start

```bash
curl -fsSL -o reach-check \
    https://github.com/${OWNER}/${REPO}/raw/main/reach-check
chmod +x reach-check
./reach-check https://example.com/health
```
...
Last release: **0.9.1** built on `2026-06-12T13:42:38Z`.
